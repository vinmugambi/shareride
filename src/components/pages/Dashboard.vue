      ...
      <b-container>
        ...
        <b-collapse is-nav
          ...
          <b-navbar-nav class="mx-auto">
            <b-nav-item @click="activate(0)"
                        :class="{'active': activeitem==0}">my rides</b-nav-item>
            <b-nav-item @click="activate(1)"
                        :class="{'active': activeitem==1}">my subscriptions</b-nav-item>
            <b-nav-item @click="activate(2)"
                        :class="{'active': activeitem==2}">browse rides</b-nav-item>
          </b-navbar-nav>
...
import Myrides from "../Myrides.vue";
